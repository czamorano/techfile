...
public class EtiologiaResource {
    ...
    @Timed
    public ResponseEntity<List<Etiologia>> getAllEtiologias(Pageable pageable) {
        log.debug("REST request to get a page of Etiologias");
        Page<Etiologia> page = etiologiaRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/etiologias");
