...
@Component({
    selector: 'jhi-provincia-my-suffix',
    templateUrl: './provincia-my-suffix.component.html'
})
export class ProvinciaMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.provinciaService
            ...
            .subscribe(
                (res: HttpResponse<IProvinciaMySuffix[]>) => this.paginateProvincias(res.body, res.headers),
    ...
    trackId(index: number, item: IProvinciaMySuffix) {
        return item.id;
    }
    ...
    private paginateProvincias(data: IProvinciaMySuffix[], headers: HttpHeaders) {
