...
import es.imserso.techfile.config.audit.AuditEventConverter;
import es.imserso.techfile.domain.PersistentAuditEvent;
...
import static es.imserso.techfile.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
