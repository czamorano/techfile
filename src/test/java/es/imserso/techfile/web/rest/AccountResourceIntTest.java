...
import es.imserso.techfile.config.Constants;
import es.imserso.techfile.TechfileApp;
import es.imserso.techfile.domain.Authority;
import es.imserso.techfile.domain.User;
import es.imserso.techfile.repository.AuthorityRepository;
import es.imserso.techfile.repository.UserRepository;
import es.imserso.techfile.security.AuthoritiesConstants;
import es.imserso.techfile.service.MailService;
import es.imserso.techfile.service.dto.UserDTO;
import es.imserso.techfile.service.dto.PasswordChangeDTO;
import es.imserso.techfile.web.rest.errors.ExceptionTranslator;
import es.imserso.techfile.web.rest.vm.KeyAndPasswordVM;
import es.imserso.techfile.web.rest.vm.ManagedUserVM;
import es.imserso.techfile.service.UserService;
