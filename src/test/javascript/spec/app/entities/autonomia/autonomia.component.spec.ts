...
import { AutonomiaComponent } from 'app/entities/autonomia/autonomia.component';
...
describe('Component Tests', () => {
    describe('Autonomia Management Component', () => {
        let comp: AutonomiaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AutonomiaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.autonomias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
