    ...
    describe('Usuario Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Usuario', () => {
                service.create(new Usuario(null)).subscribe(received => {
            ...
            it('should update a Usuario', () => {
                service.update(new Usuario(123)).subscribe(received => {
